;(function ($) {
    "use strict";
    var FUNITER = {}, $body = $('body');
    // ======================================================
    // FUNITER TAB NAVIGATION
    // ------------------------------------------------------
    ...
    $.fn.FUNITER_TAB_NAVIGATION = function () {
        var _i = 0;
    ...
    // FUNITER DATEPICKER
    // ===================================================
    $.fn.FUNITER_DATEPICKER = function () {
        return this.each(function () {
            var $this   = $(this),
    ...
    // ------------------------------------------------------
    $.fn.FUNITER_STICKYHEADER = function () {
    ...
    jQuery(document).ready(function ($) {
        /* FRAMEWORK JS */
        $('.cs-framework').FUNITER_STICKYHEADER();
        $('.cs-field-date', this).FUNITER_DATEPICKER();
        $('.cs-framework').FUNITER_TAB_NAVIGATION();
        $(document).on('change', function () {
            $('.funiter_select_preview').FUNITER_PREVIEW_SELECT();
        });
        ...
        $(document).ajaxComplete(function (event, xhr, settings) {
            $('.funiter_vc_taxonomy').FUNITER_AUTOCOMPLETE();
            $('.funiter_select_preview').FUNITER_PREVIEW_SELECT();
        });
        if ( wp.media ) {
