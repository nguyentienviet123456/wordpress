<?php
/**
 * Widget API: Funiter_Custom_Menu_Widget class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see WP_Widget
 */
class Funiter_Custom_Menu_Widget extends WP_Widget
{
	/**
	...
	public function __construct()
	{
		...
		parent::__construct( 'funiter_nav_menu', __( 'Funiter: Custom Menu' ), $widget_ops );
	}
 ...
 * @since 2.3.0
 */
function Funiter_Custom_Menu_Widget()
{
	register_widget( 'Funiter_Custom_Menu_Widget' );
}

add_action( 'widgets_init', 'Funiter_Custom_Menu_Widget' );