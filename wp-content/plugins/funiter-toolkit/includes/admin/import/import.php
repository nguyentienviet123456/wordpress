...
if ( !class_exists( 'FUNITER_IMPORTER' ) ) {
	class FUNITER_IMPORTER
	{
		...
		public function __construct()
		{
			...
			$registed_menu = array(
				'primary'        => esc_html__( 'Primary Menu', 'funiter-toolkit' ),
				'gradient_menu'  => esc_html__( 'Gradient Menu', 'funiter-toolkit' ),
				'vertical_menu'  => esc_html__( 'Vertical Menu', 'funiter-toolkit' ),
				'top_left_menu'  => esc_html__( 'Top Left Menu', 'funiter-toolkit' ),
				'top_right_menu' => esc_html__( 'Top Right Menu', 'funiter-toolkit' ),
			);
			$menu_location = array(
			...
			$data_filter   = array(
				'data_demos'    => array(
					array(
						'name'           => esc_html__( 'Import Demo', 'funiter-toolkit' ),
						'slug'           => 'home-01',
						'menus'          => $registed_menu,
						'homepage'       => 'Home 01',
						'blogpage'       => 'Blog',
						'preview'        => get_theme_file_uri( 'screenshot.jpg' ),
						'demo_link'      => 'https://funiter.namcrafted.com',
						'menu_locations' => $menu_location,
						'theme_option'   => FUNITER_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => FUNITER_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => FUNITER_IMPORTER_DIR . '/data/widgets.wie',
						'revslider_path' => FUNITER_IMPORTER_DIR . '/data/revsliders/',
					),
				),
				'item_import'   => array(
			...
			$import_data   = apply_filters( 'funiter_data_import', $data_filter );
			// SET DATA DEMOS
		...
		{
			$this->define( 'FUNITER_IMPORTER_DIR', plugin_dir_path( __FILE__ ) );
			$this->define( 'FUNITER_IMPORTER_URI', plugin_dir_url( __FILE__ ) );
		}
		...
		{
			if ( $hook_suffix == 'toplevel_page_funiter_menu' ) {
				wp_enqueue_style( 'thickbox' );
				wp_enqueue_style( 'kt-importer-style', FUNITER_IMPORTER_URI . '/assets/circle.css' );
				wp_enqueue_style( 'kt-importer-circle', FUNITER_IMPORTER_URI . '/assets/import.css' );
				wp_enqueue_script( 'thickbox' );
				wp_enqueue_script( 'kt-importer-script', FUNITER_IMPORTER_URI . '/assets/import.js', array( 'jquery' ), false );
			}
		}
            ...
            <div class="kt-importer-wrapper">
                ...
                <div class="note">
                    ...
                    <p>Please ensure you have already installed and
                        activated Funiter Toolkit, WooCommerce, Visual
		...
		public function before_content_import()
		{
			if ( class_exists( 'WooCommerce' ) ) {
				...
				if ( current_user_can( 'administrator' ) ) {
					...
					$attributes = apply_filters( 'funiter_import_wooCommerce_attributes', $attributes );
			...
			do_action( 'funiter_before_content_import' );
		}
