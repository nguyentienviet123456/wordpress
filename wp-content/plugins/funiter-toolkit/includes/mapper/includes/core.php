<?php
class Funiter_Mapper {
	/**
	 * Variable to hold class prefix supported for autoloading.
	 *
	 * @var  string
	 */
	protected static $prefix = 'Funiter_Mapper_';
	...
	public static function initialize() {
		...
		Funiter_Mapper_Post_Type::initialize();

		// Initialize shortcode.
		Funiter_Mapper_Shortcode::initialize();

		// Add image size for woocommerce product
        $size_thumb = apply_filters('funiter_pinmap_product_thumbnail',array('width'=>100,'height'=>150,'crop'=>true));
		add_image_size( 'funiter-wc-thumbnail', $size_thumb['width'], $size_thumb['height'], $size_thumb['crop'] );
	}
	...
	public static function autoload( $class_name ) {
		...
		$base = FUNITER_TOOLKIT_PATH . '/includes/mapper/includes/';
...
$funiter_papper = new  Funiter_Mapper();
$funiter_papper::initialize();
