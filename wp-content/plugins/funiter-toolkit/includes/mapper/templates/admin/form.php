<?php
    ...
    // Get current image.
    $attachment_id = get_post_meta($post->ID, 'funiter_mapper_image', true);
    ...
    $settings = get_post_meta($post->ID, 'funiter_mapper_settings', true);

    // Get all pins.
    $pins = get_post_meta($post->ID, 'funiter_mapper_pins', true);
?>
<script type="text/html" id="funiter_mapper_tmpl">
    <div class="funiter-mapper-wrap">
        <div class="funiter-mapper-top">
            <div class="title">
                <input type="text" name="post_title" class="input-text" placeholder="<?php
                    _e('Enter Title Here', 'funiter-toolkit');
                ?>" value="<?php
                    esc_attr_e($post->post_title);
                ?>">
            </div>
        </div><!-- .funiter-mapper-top -->
        <div class="funiter-mapper bdgr bgw">
            <div class="funiter-mapper-mid fc aic jcsb pd__20 bggr">
                <div class="global-setting fc aic">
                    <div id="general-settings">
                        <a href="javascript:void(0)" class="btn br__3 dib">
                            <i class="wricon-cog mr__5"></i>
                            <?php _e('General Settings', 'funiter-toolkit'); ?>
                        </a>
                        ...
                        <div class="setting-box general-setting br__3 bgw bdgr">
                            ...
                            <ul class="nav mg__0 fc">
                                <li data-nav="style"
                                    class="mg__0 active"><?php _e('Style Settings', 'funiter-toolkit'); ?></li>
                                <!-- <li data-nav="image-effect" class="mg__0"><?php _e('Image Effect', 'funiter-toolkit'); ?></li> -->
                            </ul>

                            <div class="tab-content">
                                <div data-tab="style" class="tab-item">
                                    <label class="db mb__10"><?php _e('Popup size', 'funiter-toolkit'); ?></label>
                                    <div class="row mb__25">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Width', 'funiter-toolkit'); ?></label>
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Height', 'funiter-toolkit'); ?></label>
                                            <div class="input-unit pr">
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Tooltip style', 'funiter-toolkit'); ?></label>
                                            <div class="select-styled pr">
                                                <select name="tooltip-style" class="slt select-large">
                                                    <option value="light"><?php _e('Light', 'funiter-toolkit'); ?></option>
                                                    <option value="dark"><?php _e('Dark', 'funiter-toolkit'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup box shadow', 'funiter-toolkit'); ?></label>
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup show fffect', 'funiter-toolkit'); ?></label>
                                            <div class="select-styled pr">
                                                <select name="popup-show-effect" class="slt select-large">
                                                    <option value=""><?php _e('None', 'funiter-toolkit'); ?></option>
                                                    <option value="fade"><?php _e('Fade In', 'funiter-toolkit'); ?></option>
                                                    <option value="slide-left"><?php _e('Slide From Left', 'funiter-toolkit'); ?></option>
                                                    <option value="slide-right"><?php _e('Slide From Right', 'funiter-toolkit'); ?></option>
                                                    <option value="slide-top"><?php _e('Slide From Top', 'funiter-toolkit'); ?></option>
                                                    <option value="slide-bottom"><?php _e('Slide From Bottom', 'funiter-toolkit'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup border radius', 'funiter-toolkit'); ?></label>
                                            <div class="input-unit pr">
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup border width', 'funiter-toolkit'); ?></label>
                                            <div class="input-unit pr">
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup border color', 'funiter-toolkit'); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Image effect', 'funiter-toolkit'); ?></label>
                                            <div class="select-styled pr">
                                                <select name="image-effect" class="slt select-large">
                                                    <option value="none"><?php _e('None', 'funiter-toolkit'); ?></option>
                                                    <option value="blur"><?php _e('Blur', 'funiter-toolkit'); ?></option>
                                                    <option value="gray"><?php _e('Gray', 'funiter-toolkit'); ?></option>
                                                    <option value="mask"><?php _e('Mask Overlay', 'funiter-toolkit'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="cm-4" data-image-effect="mask">
                                            <label class="db mb__10"><?php _e('Mask color', 'funiter-toolkit'); ?></label>
                                            <div class="picker-styled pr">
                    ...
                    <div class="funiter-copy-shortcode">
                        <span class="shortcode-name"><?php echo esc_html__('Copy Shortcode','funiter')?></span>
                        <input id="shortcode-syntax" class="shortcode-syntax" value='[funiter_mapper id="<?php echo absint($post->ID); ?>"]'>
                    </div>
                </div>
            </div><!-- .funiter-mapper-mid -->

            <div class="funiter-mapper-bot pr aic fc jcc <?php if ($attachment_id) echo 'pr'; ?>">
                <input type="hidden" id="funiter_mapper_image" name="funiter_mapper_image"
                       value="<?php echo absint($attachment_id); ?>">

                <?php if ($attachment_id) : ?>
                    <div class="edit-image pr">
                        <a id="change-image" href="#" class="btn-change-image pa db br__3">
                            <i class="wricon-camera mr__5"></i><?php _e('Change Image', 'funiter-toolkit'); ?>
                        </a>
                ...
                <?php else : ?>
                    <div class="add-image">
                        ...
                        <span class="empty-mapper"><?php _e('Add your image mapping', 'funiter-toolkit'); ?></span>
                    </div>
                <?php endif; ?>
            </div><!-- .funiter-mapper-bot -->
        </div><!-- .funiter-mapper -->
    </div>
</script>

<script type="text/html" id="funiter_mapper_image_tmpl">
    <div class="edit-image pr">
        <a id="change-image" href="#" class="btn-change-image pa db br__3">
            <i class="fa fa-camera-retro mr__5" aria-hidden="true"></i><?php _e('Change Image', 'funiter-toolkit'); ?>
        </a>
...
<script type="text/html" id="funiter_mapper_pin_tmpl">
    ...
    <div class="setting-box pin-setting br__3 bgw bdgr">
        <h4 class="mg__0 pr">
            <?php _e('Pin Settings', 'funiter-toolkit'); ?>
            <i class="close-box pa">x</i>
        </h4>
        ...
        <ul class="nav mg__0 fc">
            <li data-nav="general" class="mg__0 active"><?php _e('General', 'funiter-toolkit'); ?></li>
            <li data-nav="icon-settings" class="mg__0"><?php _e('Icon Settings', 'funiter-toolkit'); ?></li>
            <li data-nav="popup-settings" class="mg__0"><?php _e('Popup Settings', 'funiter-toolkit'); ?></li>
        </ul>
        ...
        <div class="tab-content">
            <div data-tab="general" class="tab-item">
                <div class="radio-group fc mb__25">
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <span></span>
                            <?php _e('WooCommerce', 'funiter-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                ...
                <div class="form-input mb__25" data-pin-type="woocommerce">
                    <label class="db mb__10"><?php _e('Select product', 'funiter-toolkit'); ?></label>
                    ...
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <input type="checkbox" onchange="jQuery(this).prev().val(this.checked ? 1 : 0);"
                                   checked="checked">
                            <span></span>
                            <?php _e('Show thumbnail', 'funiter-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <input type="checkbox" onchange="jQuery(this).prev().val(this.checked ? 1 : 0);"
                                   checked="checked">
                            <span></span>
                            <?php _e('Show description', 'funiter-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <input type="checkbox" onchange="jQuery(this).prev().val(this.checked ? 1 : 0);"
                                   checked="checked">
                            <span></span>
                            <?php _e('Show rate', 'funiter-toolkit'); ?>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-input mb__25" data-pin-type="image|text|link">
                    <label class="db mb__10"><?php _e('Popup title', 'funiter-toolkit'); ?></label>
                    <input type="text" data-option="settings[popup-title]" class="input-text input-large" value=""
                           placeholder="<?php
                               _e('Input a title for the popup here...', 'funiter-toolkit');
                           ?>">
                </div>

                <!-- Image Settings -->
                <div class="input-group mb__25" data-pin-type="image">
                    <label class="db mb__10"><?php _e('Select image', 'funiter-toolkit'); ?></label>
                    <div class="pr">
                ...
                <div class="row mb__25" data-pin-type="image|link">
                    <div class="cm-7">
                        <div class="form-input">
                            <label class="db mb__10"><?php _e('Link To', 'funiter-toolkit'); ?></label>
                            <input type="text" data-option="settings[image-link-to]" class="input-text input-large"
                                   value="">
                        </div>
                    </div>
                    <div class="cm-5">
                        <label class="db mb__10"><?php _e('Target', 'funiter-toolkit'); ?></label>
                        <div class="select-styled pr">
                            <select data-option="settings[image-link-target]" class="slt select-large">
                                <option value="_self"><?php _e('Default', 'funiter-toolkit'); ?></option>
                                <option value="_blank"><?php _e('New Tab', 'funiter-toolkit'); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-input" data-pin-type="text">
                    <label class="db mb__10"><?php _e('Text Content', 'funiter-toolkit'); ?></label>
                    <textarea data-option="settings[text]" rows="6" placeholder="<?php
                        _e('Input some content for the popup here...', 'funiter-toolkit');
                    ?>"></textarea>
                </div>
                <!-- End Text Settings -->
            </div>
                ...
                <div class="radio-group fc mb__25">
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <span></span>
                            <?php _e('Area Text', 'funiter-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                ...
                <div data-icon-type="icon-area">
                    <div class="row mb__20">
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Text', 'funiter-toolkit' ); ?></label>
                            <input type="text" data-option="settings[area-text]" class="text-custom input-text input-large" value="">
                        </div>
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Font Size', 'funiter-toolkit' ); ?></label>
                        ...
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Text Color', 'funiter-toolkit' ); ?></label>
                            <div class="picker-styled pr">
                    ...
                    <div class="row mb--20">
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Width', 'funiter-toolkit' ); ?></label>
                            <div class="input input--number pr">
                                <input type="number" data-option="settings[area-width]" class="input-text input-large" value="32">
                            </div>
                        </div>
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Height', 'funiter-toolkit' ); ?></label>
                            <div class="input input--number pr">
                                <input type="number" data-option="settings[area-height]" class="input-text input-large" value="32">
                            </div>
                        </div>
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Border Width', 'funiter-toolkit' ); ?></label>
                            <div class="input input--number pr">
                                <input type="number" data-option="settings[area-border-width]" class="input-text input-large" value="0">
                            </div>
                        </div>
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Border Radius', 'funiter-toolkit' ); ?></label>
                            <div class="input input--number pr">
                    ...
                    <div class="row">
                        <div class="cm-6 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Background', 'funiter-toolkit' ); ?></label>
                            <div class="picker-styled pr">
                        ...
                        <div class="cm-6 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Border Color', 'funiter-toolkit' ); ?></label>
                            <div class="picker-styled pr">
            ...
            <div data-tab="popup-settings" class="tab-item hidden">
                <label class="db mb__10"><?php _e('Custom popup size', 'funiter-toolkit'); ?></label>
                <div class="row">
                    <div class="cm-4">
                        <label class="db mb__10"><?php _e('Width', 'funiter-toolkit'); ?></label>
                        <div class="input-unit pr">
                    ...
                    <div class="cm-4">
                        <label class="db mb__10"><?php _e('Position', 'funiter-toolkit'); ?></label>
                        <div class="select-styled pr">
                            <select data-option="settings[popup-position]" class="slt select-large">
                                <option value="right"><?php _e('Right', 'funiter-toolkit'); ?></option>
                                <option value="left"><?php _e('Left', 'funiter-toolkit'); ?></option>
                                <option value="top"><?php _e('Top', 'funiter-toolkit'); ?></option>
                                <option value="bottom"><?php _e('Bottom', 'funiter-toolkit'); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
...
?>
<script type="text/html" id="funiter_mapper_icon_selector_tmpl">
    <div class="icon-selector select-styled pr bdgr br__3">
        ...
        <div class="icon-wrap pa bdgr">
            <h5><?php _e('Select icon', 'funiter-toolkit'); ?><i class="close fa fa-close"></i></h5>
            <div class="funiter-icon-list bgw bdgr fc fcw">
...
<script type="text/javascript">
    jQuery(function ($) {
        $(window).load(function () {
            // Override default UI.
            var form = $($('#funiter_mapper_tmpl').text()).prepend($('#post').children('input[type="hidden"]'));
            ...
            setTimeout(function () {
                $(document).trigger('init_funiter_mapper');
            }, 500);

            // Pass data to client-side.
            window.funiter_mapper_settings = <?php echo json_encode($settings ? $settings : new stdClass()); ?>;
            window.funiter_mapper_pins = <?php echo json_encode($pins ? array_values($pins) : array()); ?>;
        });
    });
</script>
