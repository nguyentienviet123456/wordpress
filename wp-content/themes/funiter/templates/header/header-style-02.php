...
$enable_header_bottom    = Funiter_Functions::funiter_get_option( 'enable_header_bottom', false );
$enable_header_top_right = Funiter_Functions::funiter_get_option( 'enable_header_top_right', false );
$enable_header_mobile    = Funiter_Functions::funiter_get_option( 'enable_header_mobile' );
$enable_chat             = 'no-chat';
if ( ( class_exists( 'Zopim' ) ) || ( class_exists( 'jivosite' ) ) ) :
	$enable_chat = 'has-chat';
endif;
...
$header_top_mid_class = 'col-md-10 col-lg-10';
if ( $enable_header_top_right ) {
	$class[]              = 'has-header-top-right';
	$header_top_mid_class = 'col-md-8 col-lg-7';
} else {
	$class[] = 'no-header-top-right';
}
    ...
    <header id="header" class="<?php echo esc_attr( implode( ' ', $class ) ); ?>">
        ...
        <div class="main-top">
            ...
            <div class="main-header">
                    ...
                    <div class="container">
                        <div class="header-nav-inner header-position">
                            <div class="row">
                                ...
                                <div class="<?php echo esc_attr( $header_top_mid_class ); ?>">
								...
								<?php if ( $enable_header_top_right ) { ?>
				...
				<?php if ( $enable_header_bottom ) { ?>
                    <div class="header-middle <?php echo esc_attr( $enable_chat ) ?>">
                        <div class="container">
                                    ...
                                    <div class="header-contact-online">
                                        <div class="header-contact-online-inner">
											<?php if ( ( class_exists( 'Zopim' ) ) || ( class_exists( 'jivosite' ) ) ) : ?>
                                                <div class="line-chat"><span
                                                            class="flaticon-comment"></span> <?php echo esc_html( 'Chat', 'funiter' ); ?>
                                                </div>
											<?php endif; ?>
