...
if ( $funiter_enable_vertical == 1 ) :
	$enable_vertical = 'has-vertical-menu';
endif;
...
<header id="header" class="header <?php echo esc_attr( implode( ' ', $class ) ); ?>">
	...
	<div class="main-top">
		...
		<div class="main-header">
		    ...
		    <div class="header-nav header-wrap-stick">
		        <div class="container">
		            <div class="header-nav-inner header-position  <?php echo esc_attr($enable_vertical) ?> <?php echo esc_attr($enable_chat) ?>">
		                ...
		                <?php if ((class_exists('Zopim')) || (class_exists('jivosite')) ) : ?>
				            <div class="line-chat-wrap"><div class="line-chat"><span class="flaticon-comment"></span> <?php echo esc_html( 'Chat', 'funiter' ); ?></div></div>
				        <?php endif; ?>
