<?php
/**
 * Class Name: funiter_bootstrap_navwalker
 ...
 */
if ( !class_exists( 'Funiter_navwalker' ) ) {
	class Funiter_navwalker extends Walker_Nav_Menu
	{
		/**
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 )
		{
			...
			if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
				...
				$attributes = ' class="funiter-menu-item-title"';
		...
		public static function fallback( $args )
		{
			if ( current_user_can( 'manage_options' ) ) {
				...
				$fb_output .= '>';
				$fb_output .= '<li class="menu-item"><a href="' . admin_url( 'nav-menus.php' ) . '">' . esc_html__( 'Add a menu', 'funiter' ) . '</a></li>';
				$fb_output .= '</ul>';
				if ( $container )
