...
(function ($) {
    ...
    $(document).ready(function () {
        $('body').on('click', '.funiter_image_menu', function (e) {
            e.preventDefault();
            var t            = $(this),
            ...
            frame.on('select', function () {
                ...
                if ( t.hasClass('icon_image') ) {
                    var html           = '<img class="image-icon" src="' + attachment.url + '" alt="funiter" />';
        ...
        $(document).on('change keyup', '.funiter-icon-search', function () {
